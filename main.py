...
class mainWindow (QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # effect = QGraphicsDropShadowEffect(context_menu)
        # effect.setOffset(0, 0)
        # context_menu.setGraphicsEffect(effect)
...
class UserSettings (QWidget):
    ...
    def addDefaultSearchEngineSelector(self):
        self.searchEngineSelector = QtWidgets.QComboBox (self)
        self.searchEngineSelector.setEnabled (True)
        self.searchEngineSelector.setGeometry (QtCore.QRect (480, 80, 211, 30))
